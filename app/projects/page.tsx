  ...
  return (
    <div className="min-h-screen text-white font-mono" style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <div className="hidden md:flex h-screen overflow-hidden">
        ...
        {/* Right Side - Content */}
        <div className="w-3/5 px-12 py-8 flex flex-col justify-between overflow-hidden">
          {/* Header Navigation */}
          ...
          {/* Content Sections */}
          <div className="text-left flex-1 overflow-hidden flex flex-col justify-start">
            {/* Projects Section */}
